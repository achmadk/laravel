...
<head>
    ...
    <style>
        ...
        @page { margin: 0; }
        body { font-family: 'Plus Jakarta Sans','Helvetica','Arial',sans-serif; width: 58mm; margin: 0; padding: 6px; font-size: 11px; line-height: 1.4; }
...
<body>
    ...
    <div class="section">
        ...
        @if($tax > 0)
            <div style="display:flex; justify-content:space-between;">
                <span>PPN {{ number_format((float) $taxRate, 0) }}%</span>
