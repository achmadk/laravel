          ...
          {recentTransactions.length > 0 && (
            <div className="grid grid-cols-1 gap-3 md:grid-cols-2 lg:grid-cols-3">
              {recentTransactions.map((trx: any, index: number) => (
                ...
                >
                  <div>
                    <p className="text-sm font-semibold text-fg">{trx.invoice}</p>
          ...
          {lowStockProducts.length > 0 && (
            <div className="grid grid-cols-1 gap-3 md:grid-cols-2 lg:grid-cols-3">
              {lowStockProducts.map((product: any, index: number) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    <span className="flex size-7 items-center justify-center rounded-full bg-danger/10 text-sm font-semibold text-danger">
                      {index + 1}
                    </span>
                    <span className="max-w-[140px] truncate text-sm font-semibold text-danger">
                      {product.name}
                    </span>
                  </div>
