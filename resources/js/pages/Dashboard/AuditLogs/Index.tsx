    ...
    <>
      ...
      <div className="mb-4 grid grid-cols-1 gap-3 rounded-2xl border border-border bg-bg p-4 md:grid-cols-3">
        ...
        <input
          ...
          className="h-11 rounded-xl border border-input bg-muted px-4 text-fg text-sm outline-none transition placeholder:text-muted-fg focus:border-ring focus:ring-2 focus:ring-ring"
        />
      </div>

      <div className="overflow-hidden rounded-lg border border-border bg-bg">
        <div className="rounded-t-lg border-border border-b bg-bg p-4">
          <div className="flex items-center gap-2 font-semibold text-fg text-sm">Histori Audit</div>
        </div>
          ...
          <table className="w-full text-sm">
            <thead className="border-border border-b bg-muted">
              <tr>
                ...
                <th className="h-12 w-20 px-4 text-center align-middle font-medium text-muted-fg">
                  Aksi
                </th>
              </tr>
            </thead>
                  ...
                  <tr key={log.id} className="transition-colors hover:bg-muted">
                    ...
                    <td className="whitespace-nowrap p-4 align-middle">
                      <div>
                        ...
                        <p className="text-muted-fg text-xs">{log.user?.email || "-"}</p>
                      </div>
                    </td>
                    <td className="whitespace-nowrap p-4 align-middle text-muted-fg">
                      {log.module}
                    ...
                    <td className="whitespace-nowrap p-4 text-center align-middle">
                      <Link
                        ...
                        className="inline-flex items-center gap-1 rounded-lg border border-border px-3 py-1.5 font-medium text-fg text-xs hover:bg-muted"
                      >
                        <IconEye size={14} />
                        Detail
                      </Link>
