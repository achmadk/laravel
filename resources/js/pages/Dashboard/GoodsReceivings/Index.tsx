        ...
        <Card>
          <CardContent className="p-0">
            <div className="border-border border-b px-5 py-4">
              <h2 className="font-semibold text-fg text-lg">Daftar Penerimaan Barang</h2>
            </div>
                  ...
                  {receivings.data.length > 0 ? (
                    receivings.data.map((gr) => (
                      ...
                      >
                        ...
                        <td className="px-3 py-3 text-fg text-sm">{gr.supplier?.name || "-"}</td>
                        <td className="px-3 py-3 text-fg text-sm">
                          {formatDateTime(gr.received_at)}
                        </td>
                        <td className="px-3 py-3 text-fg text-sm">{gr.receiver?.name || "-"}</td>
