    ...
    <>
      ...
      <div className="mb-6">
        ...
        <div className="flex items-center gap-2">
          <h1 className="font-bold text-2xl text-fg">{receiving.document_number}</h1>
        </div>
                    ...
                    receiving.items.map((item) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <td className="px-3 py-3 text-muted-fg text-xs">{item.notes || "-"}</td>
                        </tr>
                      );
                    })
                  ) : (
          ...
          {receiving.notes && (
            <Card>
              <CardContent className="p-5">
                ...
                <p className="text-muted-fg text-sm">{receiving.notes}</p>
              </CardContent>
            </Card>
          )}
