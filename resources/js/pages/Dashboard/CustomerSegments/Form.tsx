        ...
        <form onSubmit={submit} className="space-y-6">
          <div className="rounded-2xl border border-border bg-bg p-5">
            <div className="mb-4 flex items-center gap-3">
              ...
              <div>
                <h2 className="font-semibold text-fg text-lg">Informasi Segment</h2>
                <p className="text-muted-fg text-sm">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <div>
                <label className="mb-2 block font-medium text-fg text-sm">Nama Segment</label>
                <input
                  type="text"
                  value={data.name}
              ...
              <div>
                <label className="mb-2 block font-medium text-fg text-sm">Tipe Segment</label>
                <select
                  value={data.type}
              ...
              <div className="md:col-span-2">
                <label className="mb-2 block font-medium text-fg text-sm">Deskripsi</label>
                <textarea
                  rows={3}
              ...
              <label className="inline-flex items-center gap-3 rounded-2xl border border-input bg-muted px-4 py-3">
                ...
                />
                <span className="font-medium text-fg text-sm">Segment aktif</span>
              </label>
            </div>
          </div>
          ...
          {data.type === "auto" && (
            <div className="rounded-2xl border border-border bg-bg p-5">
              <h2 className="mb-4 font-semibold text-fg text-lg">Rule Auto Segment</h2>
              <div className="grid gap-4 md:grid-cols-2">
                <div>
                  <label className="mb-2 block font-medium text-fg text-sm">Rule Type</label>
                  <select
                ...
                {data.auto_rule_type === "receivable_behavior" && (
                  <div className="space-y-3 md:col-span-2">
                    ...
                    <label className="inline-flex items-center gap-3 rounded-2xl border border-input bg-muted px-4 py-3">
                      ...
                      />
                      <span className="font-medium text-fg text-sm">Hanya piutang overdue</span>
                    </label>
                  </div>
                )}
              </div>
