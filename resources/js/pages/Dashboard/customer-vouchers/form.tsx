        ...
        <form onSubmit={submit} className="space-y-6">
          <section className="rounded-2xl border border-border bg-bg p-5">
            <div className="mb-4 flex items-center gap-3">
              ...
              <div>
                <h2 className="text-lg font-semibold text-fg">Informasi Voucher</h2>
                <p className="text-smtext-muted-fg">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <div className="md:col-span-2">
                <label className="mb-2 block text-sm font-medium text-fg">Pelanggan</label>
                <select
              ...
              <div>
                <label className="mb-2 block text-sm font-medium text-fg">Kode Voucher</label>
                <input
                  type="text"
                  value={data.code}
              ...
              <div>
                <label className="mb-2 block text-sm font-medium text-fg">Nama Voucher</label>
                <input
                  type="text"
                  value={data.name}
          ...
          <section className="rounded-2xl border border-border bg-bg p-5">
            <h2 className="mb-4 text-lg font-semibold text-fg">Benefit & Periode</h2>
            <div className="grid gap-4 md:grid-cols-2">
              <div>
              ...
              <div>
                <label className="mb-2 block text-sm font-medium text-fg">Minimum Belanja</label>
                <input
                  type="number"
                  min="0"
              ...
              <div className="flex items-end">
                <label className="inline-flex items-center gap-3 rounded-2xl border border-border bg-muted px-4 py-3">
                  ...
                  />
                  <span className="text-sm font-medium text-fg">Voucher aktif</span>
                </label>
              </div>
              <div>
                <label className="mb-2 block text-sm font-medium text-fg">Mulai Berlaku</label>
                <input
                  type="datetime-local"
              ...
              <div>
                <label className="mb-2 block text-sm font-medium text-fg">Berakhir Pada</label>
                <input
                  type="datetime-local"
