      ...
      <div className="space-y-6">
        <div>
          <Link
            ...
            className="inline-flex items-center gap-2 text-smtext-muted-fg hover:text-primary-600 mb-3"
          >
        ...
        <form onSubmit={submit} className="space-y-6">
          ...
          >
            <div className="grid gap-4 md:grid-cols-2">
              <div>
                <label className="mb-2 block text-sm font-medium text-fg">Nama Rule</label>
                <input
                  type="text"
                  value={data.name}
              ...
              <div>
                <label className="mb-2 block text-sm font-medium text-fg">Jenis Rule</label>
                <select
                  value={data.kind}
                  onChange={(e) => {
              ...
              <div>
                <label className="mb-2 block text-sm font-medium text-fg">Qty Preview POS</label>
                <input
                  type="number"
                  min="1"
          ...
          >
            <div className="grid gap-4 md:grid-cols-2">
              <div>
                <label className="mb-2 block text-sm font-medium text-fg">Target Rule</label>
                <select
              ...
              <div>
                <label className="mb-2 block text-sm font-medium text-fg">Scope Pelanggan</label>
                <select
              ...
              {data.target_type === "product" && (
                <div className="md:col-span-2">
                  <label className="mb-2 block text-sm font-medium text-fg">Produk</label>
                  <select
              ...
              {data.target_type === "category" && (
                <div className="md:col-span-2">
                  <label className="mb-2 block text-sm font-medium text-fg">Kategori</label>
                  <select
          ...
          {discountSections && (
            ...
            >
              <div className="grid gap-4 md:grid-cols-2">
                <div>
                  <label className="mb-2 block text-sm font-medium text-fg">Tipe Diskon</label>
                  <select
                ...
                <div>
                  <label className="mb-2 block text-sm font-medium text-fg">Nilai Diskon</label>
                  <input
                    type="number"
                    min="0.01"
                    step="0.01"
            ...
            >
              <div className="space-y-3">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-2 rounded-xl border border-border px-4 py-2 text-sm font-medium text-fg"
                >
                  <IconPlus size={16} />
                  Tambah Break
                </button>
          ...
          {data.kind === "bundle_price" && (
            ...
            >
              <div className="mb-4">
                <label className="mb-2 block text-sm font-medium text-fg">Harga Bundle</label>
                <input
                  type="number"
                  min="1"
                  value={data.discount_value}
          ...
          >
            <div className="grid gap-4 md:grid-cols-2">
              <div>
                <label className="mb-2 block text-sm font-medium text-fg">Mulai</label>
                <input
                  type="datetime-local"
              ...
              <div>
                <label className="mb-2 block text-sm font-medium text-fg">Berakhir</label>
                <input
                  type="datetime-local"
                  value={data.ends_at}
              ...
              <label className="flex items-center gap-3 rounded-xl border border-border bg-muted px-4 py-3 text-sm font-medium">
                <input
                  type="checkbox"
          ...
          >
            <div className="mb-4 flex flex-wrap gap-3">
              <button
                type="button"
                onClick={runPreview}
                className="inline-flex items-center gap-2 rounded-xl border border-primary/30 bg-primary/10 px-4 py-2 text-sm font-medium text-primary"
              >
            ...
            {previewState.data && (
              <div className="space-y-4">
                ...
                {previewGroups.length > 0 && (
                  <div className="rounded-xl border border-border bg-muted p-4">
                    <h3 className="mb-3 text-sm font-semibold text-fg">Applied Groups</h3>
          ...
          <div className="flex flex-col gap-3 border-t border-border pt-4 sm:flex-row sm:items-center sm:justify-between">
            <Link
              href={pricingRules.index.url()}
              className="inline-flex items-center justify-center rounded-xl border border-border bg-bg px-5 py-2.5 text-sm font-medium text-fg hover:bg-muted"
            >
              Batal
            </Link>
            <button
