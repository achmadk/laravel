    ...
    <>
      ...
      <div className="space-y-6">
        ...
        <form
          ...
          className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3 bg-bg border border-border rounded-2xl p-4"
        >
              ...
              {hasData ? (
                rules.data.map((rule) => (
                  ...
                  >
                    <div className="col-span-3">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-muted-fg">{formatDate(rule.starts_at)}</p>
                        </div>
                      </div>
                    </div>
                    <div className="col-span-2 text-sm text-fg">{targetLabel(rule)}</div>
                    <div className="col-span-1 text-sm text-fg">
                    ...
                    <div className="col-span-2 text-sm font-semibold text-fg">
                      {discountLabel(rule)}
                    </div>
                    <div className="col-span-1 text-center text-sm text-fg">{rule.priority}</div>
        ...
        {recentAudits.length > 0 && (
          <div className="rounded-2xl border border-border bg-bg p-4">
            <h2 className="text-base font-semibold text-fg">Aktivitas Promo Terbaru</h2>
              ...
              {recentAudits.map((audit) => (
                ...
                >
                  <div>
                    ...
                    <p className="text-xs text-muted-fg">{audit.event}</p>
                  </div>
                  <span className="text-xs text-muted-fg">{formatDate(audit.created_at)}</span>
                </div>
              ))}
            </div>
          </div>
