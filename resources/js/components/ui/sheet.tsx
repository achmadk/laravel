...
const SheetContent = ({
  ...
  return (
    <ModalOverlay
      ...
      className={cx(
        "entering:fade-in exiting:fade-out fixed start-0 top-0 z-50 size-full entering:animate-in exiting:animate-out overflow-hidden bg-black/60 entering:duration-500 exiting:duration-300",
        overlay?.className,
      )}
      {...props}
    >
